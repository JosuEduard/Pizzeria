...
const Sidebar = ({ isOpen }) => {
  const menuItems = [
    ...
    { name: 'Manejar Productos', iconPlaceholder:  <IconShoppingCart stroke={2} />, href: '/products' },
    { name: 'Manejar Ordenes', iconPlaceholder: <IconArticleFilled stroke={2} />, href: '/orders' },
